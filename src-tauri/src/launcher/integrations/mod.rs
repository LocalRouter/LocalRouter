...
/// Locate a binary by name the way the user's terminal would.
///
/// Thin alias over [`lr_utils::binary::find_binary`], kept so the many
/// integration modules can keep calling `find_binary(..)` unqualified.
