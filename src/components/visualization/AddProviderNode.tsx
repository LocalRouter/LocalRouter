interface AddProviderNodeData {
  nodeType: 'AddNode';
  onClick?: () => void;
}

export function AddProviderNode({ data }: { data: AddProviderNodeData }) {
  return (
    <div
    ...
    >
      <div className="flex flex-col items-center justify-center gap-2">
        ...
        <div className="text-sm font-semibold text-gray-700">Add Provider</div>
      </div>
    </div>
  );
}
