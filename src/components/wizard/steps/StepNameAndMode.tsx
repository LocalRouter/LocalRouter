 ...
 * - LLM Routing / MCP Proxy checkboxes below
 * - Pre-selects mode based on template's defaultMode and disables unsupported options
 */
...
export function StepNameAndMode({
  ...
  const handleToggle = (key: "llm" | "mcp") => {
    ...
    onModeChange(deriveMode(newLlm, newMcp))
  }
