...
export function LlmOptimizationView({ onTabChange }: LlmOptimizationViewProps) {
    ...
    <div className="flex flex-col h-full min-h-0 gap-4 max-w-5xl">
      <div className="flex-shrink-0">
        ...
        <p className="text-sm text-muted-foreground">
          Optimize LLM requests and responses with JSON repair, prompt compression, and intelligent routing
        </p>
      </div>
