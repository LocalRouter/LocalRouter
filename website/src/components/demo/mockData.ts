  ...
  monitorEvents: [
    {
      ...
      event_type: "llm_response", client_id: "client-1", client_name: "Claude Code",
      status: "complete", duration_ms: 1250,
      summary: "openai/gpt-4o — 1,523 tokens",
      data: { type: "llm_response", provider: "openai", model: "gpt-4o", status_code: 200, input_tokens: 1200, output_tokens: 323, total_tokens: 1523, cost_usd: 0.0089, latency_ms: 1250, finish_reason: "stop", content_preview: "Here's the implementation you requested...", streamed: true },
    },
    {
      id: "mon-002", sequence: 5, timestamp: new Date(Date.now() - 2000).toISOString(),
      event_type: "llm_request", client_id: "client-1", client_name: "Claude Code",
      status: "complete", duration_ms: null,
      summary: "/v1/chat/completions → gpt-4o (12 msgs (stream))",
      data: { type: "llm_request", endpoint: "/v1/chat/completions", model: "gpt-4o", stream: true, message_count: 12, has_tools: true, tool_count: 5, request_body: { model: "gpt-4o", messages: [{ role: "system", content: "You are a helpful assistant." }, { role: "user", content: "Help me refactor this function." }] } },
    },
    {
      id: "mon-003", sequence: 4, timestamp: new Date(Date.now() - 5000).toISOString(),
      event_type: "mcp_tool_response", client_id: "client-2", client_name: "Cursor",
      status: "complete", duration_ms: 340,
      summary: "tools/call ← filesystem__read_file (OK)",
      data: { type: "mcp_tool_response", tool_name: "filesystem__read_file", server_id: "srv-1", latency_ms: 340, success: true, response_preview: '{"content": [{"type": "text", "text": "file contents here..."}]}', error: null },
    },
    {
      id: "mon-004", sequence: 3, timestamp: new Date(Date.now() - 5500).toISOString(),
      event_type: "mcp_tool_call", client_id: "client-2", client_name: "Cursor",
      status: "complete", duration_ms: null,
      summary: "tools/call → filesystem__read_file",
      data: { type: "mcp_tool_call", tool_name: "filesystem__read_file", server_id: "srv-1", server_name: "Filesystem", arguments: { path: "/Users/demo/project/src/main.rs" }, firewall_action: null },
    },
    {
      id: "mon-005", sequence: 2, timestamp: new Date(Date.now() - 10000).toISOString(),
      event_type: "llm_error", client_id: "client-3", client_name: "GPT4All",
      status: "error", duration_ms: null,
      summary: "unknown/llama-3.3 — HTTP 502",
      data: { type: "llm_error", provider: "ollama", model: "llama-3.3", status_code: 502, error: "Connection refused: could not connect to Ollama at localhost:11434" },
    },
    {
      id: "mon-006", sequence: 1, timestamp: new Date(Date.now() - 30000).toISOString(),
      event_type: "llm_request", client_id: "client-2", client_name: "Cursor",
      status: "complete", duration_ms: null,
      summary: "/v1/embeddings → text-embedding-3-small (1 msgs)",
      data: { type: "llm_request", endpoint: "/v1/embeddings", model: "text-embedding-3-small", stream: false, message_count: 1, has_tools: false, tool_count: 0, request_body: { model: "text-embedding-3-small", input: "search query" } },
    },
    {
      id: "mon-007", sequence: 0, timestamp: new Date(Date.now() - 35000).toISOString(),
      event_type: "auth_error", client_id: null, client_name: null,
      status: "error", duration_ms: null,
    ...
    },
    {
      ...
      event_type: "access_denied", client_id: "client-3", client_name: "GPT4All",
      status: "error", duration_ms: null,
    ...
    },
    {
      ...
      event_type: "rate_limit_event", client_id: "client-1", client_name: "Claude Code",
      status: "error", duration_ms: null,
    ...
    },
    {
      ...
      event_type: "validation_error", client_id: "client-2", client_name: "Cursor",
      status: "error", duration_ms: null,
    ...
    },
    {
      ...
      event_type: "mcp_server_event", client_id: null, client_name: null,
      status: "error", duration_ms: null,
