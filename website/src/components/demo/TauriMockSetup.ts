...
const mockHandlers: Record<string, (args?: any) => unknown> = {
  ...
  'list_coding_agents': () => [
    ...
    { agentType: 'antigravity', displayName: 'Antigravity', binaryName: 'agy', installed: true, binaryPath: '/home/user/.local/bin/agy', description: "Google's terminal coding agent, the successor to Gemini CLI.", supportsModelSelection: true, supportedPermissionModes: ['supervised'], mcpToolPrefix: 'antigravity' },
